module ice_mushy_physics
  ...
  real(kind=real_kind), parameter :: &
       az1_liq = -18.48_real_kind, &
       bz1_liq =    0.0_real_kind

  ! liquidus relation - lower temperature region
  real(kind=real_kind), parameter :: &
       az2_liq = -10.3085_real_kind, &
       bz2_liq =     62.4_real_kind

  ! liquidus break
  real(kind=real_kind), parameter :: &
       Tb_liq = -7.6362968855167352_real_kind, & ! temperature of liquidus break
       Sb_liq =  123.66702800276086_real_kind    ! salinity of liquidus break
  ...
  real(kind=real_kind), parameter :: &
       ki = 2.3_real_kind , & ! fresh ice conductivity (W m-1 K-1)
       kb = 0.5375_real_kind  ! brine conductivity (W m-1 K-1)
...
!=======================================================================
  ...
  function density_brine(Sbr) result(rho)
    ...
    real(kind=real_kind), parameter :: &
         a = 1000.3_real_kind    , & ! zeroth empirical coefficient
         b = 0.78237_real_kind   , & ! linear empirical coefficient
         c = 2.8008e-4_real_kind     ! quadratic empirical coefficient
