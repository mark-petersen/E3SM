...
! author: Elizabeth C. Hunke and William H. Lipscomb, LANL
      ...
      real (kind=real_kind), optional, intent(inout):: &
...
!---------------------------------------------------------------
      ...
      if (extreme_test) then
         ...
         if (fcondtopn < -100.0_real_kind & 
              .or. fcondtopn > 20.0_real_kind) then
            extreme_flag = .true.
         endif
         
         if (fsurfn < -100.0_real_kind & 
              .or. fsurfn > 80.0_real_kind) then
            extreme_flag = .true.
         endif
         
         if (flatn < -20.0_real_kind & 
              .or. flatn > 20.0_real_kind) then
            extreme_flag = .true.
         endif
