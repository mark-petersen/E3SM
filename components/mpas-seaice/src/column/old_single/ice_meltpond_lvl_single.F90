!  SVN:$Id: ice_meltpond_lvl.F90 1112 2016-03-24 22:49:56Z eclare $
!=======================================================================
...
! determine the liquid fraction of brine in the ice and the permeability
      ...
      do k = 1,nilyr
         Sbr = c1/(1.e-3_real_kind - depressT/Tin(k)) ! Notz thesis eq 3.6
      ...
      perm = 3.0e-8_real_kind * (minval(phi))**3
